                    ...
                    <div class="overflow-auto shadow-md sm:rounded-lg px-2">
                        ...
                        <div class="shadow py-2">
                            <div class="uppercase font-bold text-blue-900">
                                <h1>animal Bite treatment consultation view</h1>
                            </div>
                            <div class="">
                                            ...
                                            <div class="col-span-5">
                                                ...
                                                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-2 mb-4">
                                                    ...
                                                    @foreach ($treatment->post_exposure as $p)
                                                        ...
                                                        <div class="col-span-3 grid grid-cols-2 md:grid-cols-5 lg:grid-cols-5 gap-2 mb-4 border-t-4 border-red-500">
                                                            <div class="flex flex-col">
                                                                <label>Day</label>
                                                                <input type="text" value="{{ $p->day }}" class="rounded-md p-3 ps-2 border-0" /> 
                                                            </div>
                                                            <div class="flex flex-col">
                                                                <label>Date</label>
                                                                <input type="date" value="{{ $p->date }}" class="rounded-md p-3 ps-2 border-0" />
                                                               
                                                            </div>
                                                            <div class="flex flex-col">
                                                                <label>Time</label>
                                                                <input type="time" value="{{ $p->time }}" class="rounded-md p-3 ps-2 border-0"/>
                                                                
                                                            </div>
                                                            
                                                            <div class="flex flex-col">
                                                                <label>R/L</label>
                                                                <input type="text" value="{{ $p->rl }}" class="rounded-md p-3 ps-2 border-0"/>
                                                                    
                                                               
                                                            </div>
                                                            <div class="flex flex-col">
                                                                <label>NOD</label>
                                                                <input type="text" value="{{ $p->nod }}" class="rounded-md p-3 ps-2 border-0"/>
                                                            </div>
        
                                                            <div class="flex flex-col col-span-3">
                                                                <label>Site</label>
                                                                <input type="text" value="{{ $p->site }}" class="rounded-md p-3 ps-2 border-0"/>
                                                                
                                                            </div>
                                                            <div class="flex flex-col col-span-2">
                                                                <label>Status</label>
                                                                <input type="text" value="Completed" class="rounded-md p-3 ps-2 border-0 text-green-500"/>
