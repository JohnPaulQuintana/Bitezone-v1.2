<div class="shadow py-2 hidden" id="contents">
    <div class="uppercase font-bold text-blue-900 flex justify-between items-center">
        <h1 class="text-md sm:text-xl">animal Bite treatment consultation form.</h1>
        ...
        <form action="{{ route('admin.treatment.update') }}" method="post">
            ...
            <div class="grid grid-cols-1 bg-slate-100 p-1 md:grid-cols-3 lg:grid-cols-3 gap-2 mb-4">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="lastname" value="{{ $treatment->user->lastname }}" class="rounded-md p-2 ps-2 border-0 uppercase font-bold" readonly>
                </div>
                <div class="flex flex-col">
            ...
            {{-- VITAL SIGN'S --}}
            <div class="grid grid-cols-5 bg-slate-100  p-1 md:grid-cols-5 lg:grid-cols-5 gap-2 mb-4">
                <div class="col-span-5 md:col-span-5 lg:col-span-5 text-center uppercase font-bold text-white bg-red-500">
                    <h1>vital sign's</h1>
                </div>
                <div class="flex flex-col">
            ...
            <div class="grid grid-cols-1 bg-slate-100  p-1 md:grid-cols-2 lg:grid-cols-2 gap-2 mb-4">
                ...
                <div class="col-span-2 flex flex-col">
                    ...
                    <ul class="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-6 items-center w-full text-sm font-medium text-gray-900 bg-white rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                ...
                <div class="col-span-2 flex flex-col">
                    ...
                    <input type="text" name="pertinent_pe" value="{{ $treatment->pertinent_pe }}" class="rounded-md p-3 ps-2 border-0" readonly>
                </div>
                <div class="col-span-2 flex flex-col">
                    <label for="diagnosis">Diagnosis</label>
                    <input type="text" name="diagnosis" value="{{ $treatment->diagnosis }}" class="rounded-md p-3 ps-2 border-0" readonly>
                </div>
                <div class="col-span-2 sm:mt-5 flex flex-col">
                    <label for="home_medecine">Home Medicine</label>
                    <input type="text" name="home_medicine" value="{{ $treatment->home_medicine }}" class="rounded-md p-3 ps-2 border-0" readonly>
                </div>
                <div class="col-span-2 flex flex-col justify-center items-center">
                    
                    <input type="text" name="physician" value="{{ auth()->user()->firstname  }} {{ auth()->user()->middlename  }} {{ auth()->user()->lastname  }}" class="rounded-md w-[25%] sm:w-[50%] text-center p-3 ps-2 border-0 uppercase font-bold text-blue-900">
                    <label for="physician">Physician</label>
                </div>
            </div>
            {{-- HISTORY OF EXPOSURE --}}
            <div class="grid grid-cols-2 bg-slate-100  p-1 md:grid-cols-2 lg:grid-cols-2 gap-2 mb-4">
                ...
                <div class="col-span-2 flex flex-col">
                   <div class="grid grid-cols-4 md:grid-cols-4 lg:grid-cols-4 gap-2">
                        <div class="flex flex-col">
            ...
            <div class="grid grid-cols-1 bg-slate-100  p-1 md:grid-cols-2 lg:grid-cols-2 gap-2 mb-4">
                ...
                <div class="col-span-2 grid grid-cols-1 md:grid-cols-5 lg:grid-cols-5">
                    <div class="col-span-5">
                        
                        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-2 mb-4">
                            <div class="flex flex-col col-span-3 font-bold text-xl text-red-500 uppercase">
                                <label>Post Exposure</label>
                            </div>
                            
                            @foreach ($treatment->post_exposure as $p)
                           
                                <div class="col-span-3 grid grid-cols-5 md:grid-cols-5 lg:grid-cols-5 gap-2 mb-4 border-t-4 border-red-500">
                                    <div class="flex flex-col">
                                        <label>Day</label>
