<div class="shadow py-2">
    <div
        class="uppercase font-bold text-blue-900 flex flex-col md:flex-row lg:flex-row justify-between md:items-center lg:items-center">
        <h1
            class="text-md bg-red-500 text-white md:bg-white md:text-blue-900 text-center mb-2 md:mb-0 lg:mb-0 md:text-md lg:text-md">
            animal Bite treatment consultation form.</h1>
        ...
        <form action="{{ route('admin.treatment.update') }}" method="post">
            ...
            <div class="bg-slate-50 md:grid md:bg-slate-100 p-1 md:grid-cols-2 lg:grid-cols-3 gap-2 mb-4">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="lastname" value="{{ $treatment->user->lastname }}"
                        class="text-md rounded-md p-2 ps-2 border-0 uppercase font-bold" readonly>
                </div>
                <div class="flex flex-col">
                    <label for="middlename">Middle Name</label>
                    <input type="text" name="middlename" value="{{ $treatment->user->middlename }}"
                        class="text-md rounded-md p-2 ps-2 border-0 uppercase font-bold" readonly>
                </div>
                <div class="flex flex-col col-span-1">
                    <label for="firstname">First Name</label>
                    <input type="text" name="firstname" value="{{ $treatment->user->firstname }}"
                        class="text-md rounded-md p-2 ps-2 border-0 uppercase font-bold" readonly>
                </div>
                ...
                <div class="col-span-3">
                    <div class="grid grid-cols-2 gap-2 md:grid-cols-4 lg:grid-cols-4 ">
                        <div class="flex flex-col">
                            ...
                            <input type="number" name="age" value="<?php echo date('Y') - date('Y', strtotime($treatment->user->dateofbirth)); ?>"
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="date" name="date" value="<?php echo date('Y-m-d', strtotime($treatment->user->dateofbirth)); ?>"
                                class="rounded-md p-2 ps-2 border-0 uppercase font-bold" readonly>
                        </div>
                        {{-- <div class="flex flex-col">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="text" name="record_number" value="{{ $treatment->record_number }}"
                                class="rounded-md p-2 ps-2 border-0 " readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-span-3">
                    <div class="grid grid-cols-2 gap-2 md:grid-cols-3 lg:grid-cols-3">
                        <div class="flex flex-col">
                            ...
                            <input type="text" name="address" value="{{ $treatment->user->address }}"
                                class="rounded-md p-2 ps-2 border-0 uppercase font-bold" readonly>
                        </div>
                        <div class="flex flex-col">
                            <label for="place_of_birth">Place of Birth</label>
                            <input type="text" name="place_of_birth" value="{{ $treatment->place_of_birth }}"
                                class="rounded-md p-2 ps-2 border-0" readonly>
                        </div>
                        <div class="flex flex-col">
                            <label for="contact_no">Contact Number</label>
                            <input type="tel" name="contact_no" value="{{ $treatment->user->contact_no }}"
                                class="rounded-md p-2 ps-2 border-0 uppercase font-bold" readonly>
                        </div>
                    </div>
                </div>
            ...
            <div class="md:grid grid-cols-1 bg-slate-100  p-1 md:grid-cols-3 lg:grid-cols-3 gap-2 mb-4">
                ...
                <div class="col-span-3 flex flex-col">
                    ...
                    <input type="text" name="complain" value="{{ $treatment->chief_complain }}"
                        class="rounded-md p-3 ps-2 border-0" readonly>
                </div>
            ...
            <div class="grid grid-cols-3 bg-slate-100  p-1 md:grid-cols-5 lg:grid-cols-5 gap-2 mb-4">
                <div
                    class="col-span-3 md:col-span-5 lg:col-span-5 text-center uppercase font-bold text-white bg-red-500">
                    <h1>vital sign's</h1>
                </div>
                <div class="flex flex-col">
                    <label for="bp">BP</label>
                    <input type="text" name="bp" value="{{ $treatment->bp }}"
                        class="rounded-md p-3 ps-2 border-0" readonly>
                </div>
                <div class="flex flex-col">
                    <label for="pr">PR</label>
                    <input type="text" name="pr" value="{{ $treatment->pr }}"
                        class="rounded-md p-3 ps-2 border-0" readonly>
                </div>
                <div class="flex flex-col">
                    <label for="rr">RR</label>
                    <input type="text" name="rr" value="{{ $treatment->rr }}"
                        class="rounded-md p-3 ps-2 border-0" readonly>
                </div>
                <div class="flex flex-col">
                    <label for="temp">Temperature</label>
                    <input type="text" name="temperature" value="{{ $treatment->temp }}"
                        class="rounded-md p-3 ps-2 border-0" readonly>
                </div>
                <div class="flex flex-col">
                    <label for="wt">WT</label>
                    <input type="text" name="wt" value="{{ $treatment->wt }}"
                        class="rounded-md p-3 ps-2 border-0" readonly>
                </div>
            ...
            <div class="grid grid-cols-1 bg-slate-100  p-1 md:grid-cols-2 lg:grid-cols-2 gap-2 mb-4">
                ...
                <div class="md:col-span-2 flex flex-col">
                    ...
                    <input type="text" name="history_of_present_illness"
                        value="{{ $treatment->history_of_illness }}" class="rounded-md p-3 ps-2 border-0" readonly>
                </div>
                        ...
                        @foreach (['head', 'neck', 'shoulder-left', 'shoulder-right', 'arm-left', 'arm-right', 'elbow-left', 'elbow-right', 'hand-left', 'hand-right', 'chest', 'back', 'abdomen', 'hips', 'leg-left', 'leg-right'] as $bodyPart)
                            <li class="w-full border-b border-gray-200 sm:border-b-0 dark:border-gray-600">
                                <div class="flex items-center ps-3">
                                    <input name="body_parts[]" type="checkbox" value="{{ $bodyPart }}"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                        {{ in_array($bodyPart, $selected) ? 'checked' : '' }} disabled>
                                    <label
                                        class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ ucwords(str_replace('-', ' ', $bodyPart)) }}</label>
                                </div>
                            </li>
                        @endforeach
                    </ul>
                ...
                <div class="col-span-2 flex flex-col justify-center items-center">
                    ...
                    <div
                        class="rounded-md w-full md:w-[30%] lg:w-[30%] text-center p-3 ps-2 border-0 bg-white uppercase font-bold text-blue-900">
                        <p class="">{{ auth()->user()->firstname }} {{ auth()->user()->middlename }}
            ...
            <div class="md:grid grid-cols-1 bg-slate-100  p-1 md:grid-cols-2 lg:grid-cols-2 gap-2 mb-4">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="date" name="date_of_incidence"
                        value="{{ $treatment->exposure->date_of_incidence }}"
                        class="rounded-md p-3 ps-2 border-0 @error('date_of_incidence') error @enderror" readonly>
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="place_of_incidence"
                        value="{{ $treatment->exposure->place_of_incidence }}"
                        class="rounded-md p-3 ps-2 border-0 @error('place_of_incidence') error @enderror" readonly>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-2">
                        <div class="flex flex-col">
                            ...
                            <select name="animal"
                                ...
                                <option value="pet dog" @if ($treatment->exposure->animal_type === 'pet dog') selected @endif>Pet Dog
                                </option>
                                <option value="pet cat" @if ($treatment->exposure->animal_type === 'pet cat') selected @endif>Pet Cat
                                </option>
                                <option value="stray dog" @if ($treatment->exposure->animal_type === 'stray dog') selected @endif>Stray Dog
                                </option>
                                <option value="stray cat" @if ($treatment->exposure->animal_type === 'stray cat') selected @endif>Stray Cat
                                </option>
                                <option value="others" @if ($treatment->exposure->animal_type === 'others') selected @endif>Others
                                </option>
                            </select>
                            @error('animal')
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="text" name="status_of_animal" class="rounded-md p-3 ps-2 border-0"
                                value="{{ $treatment->exposure->animal_status }}" readonly>
                        </div>
                        <div class="flex flex-col">
                            <label for="type_of_bite">Type of Bite</label>
                            <select type="text" name="type_of_bite"
                                class="rounded-md p-3 ps-2 border-0 @error('type_of_bite') error @enderror" disabled>
                                ...
                                <option value="non-bite" @if ($treatment->exposure->type_of_bite === 'non-bite') selected @endif>Non Bite
                                </option>
                            </select>
                            @error('site_of_bite')
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="text" name="washing_of_bite" class="rounded-md p-3 ps-2 border-0"
                                value="{{ $treatment->exposure->washing_of_bite }}" readonly>

                        </div>
                        <div class="flex flex-col">
                            <label for="site_of_bite">Site of Bite</label>
                            <input type="text" name="site_of_bite"
                                value="{{ $treatment->exposure->site_of_bite }}"
                                class="rounded-md p-3 ps-2 border-0 @error('site_of_bite') error @enderror" readonly>
                            @error('site_of_bite')
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="date" name="previous_vaccination_year"
                                value="{{ $treatment->exposure->previous_vaccination }}"
                                class="rounded-md p-3 ps-2 border-0" min="1900" max="2099"
                        ...
                        <div class="flex flex-col">
                            ...
                            <select type="text" name="previous_vaccination_status"
                                class="rounded-md p-3 ps-2 border-0" disabled>
                                <option value="">Select status</option>
                                <option value="completed" @if ($treatment->exposure->status === 'completed') selected @endif>Completed
                                </option>
                                <option value="incomplete" @if ($treatment->exposure->status === 'incompleted') selected @endif>
                                    Incomplete</option>
                            </select>
                        </div>
                        <div class="flex flex-col">
                            ...
                            <select type="text" name="tissue_culture_vaccine" class="rounded-md p-3 ps-2 border-0"
                                ...
                                <option value="pvrv" @if ($treatment->exposure->tissue_culture_vaccine === 'pvrv') selected @endif>PVRV
                                </option>
                        ...
                        <div class="flex flex-col">
                            ...
                            <select type="text" name="rabies_immunoglobulin" class="rounded-md p-3 ps-2 border-0"
                                disabled>
                                <option value="">Select here</option>
                                <option value="equirab" @if ($treatment->exposure->rabies_immunoglobulin === 'equirab') selected @endif>EQUIRAB
                                </option>
                                <option value="ravirab" @if ($treatment->exposure->rabies_immunoglobulin === 'ravirab') selected @endif>RAVBIRAB
                                </option>
                            </select>
                        </div>
                        <div class="flex flex-col">
                            <label for="erig">ERIG</label>
                            <input type="text" name="erig" value="{{ $treatment->exposure->erig }}"
                                class="rounded-md p-3 ps-2 border-0" readonly>
                        </div>
                        <div class="flex flex-col">
                            <label for="dose">DOSE (ml)</label>
                            <input type="number" name="dose" value="{{ $treatment->exposure->dose }}"
                                class="rounded-md p-3 ps-2 border-0" min="1" max="1000" readonly>
                        </div>
                        <div class="flex flex-col">
                            <label for="anti_tetanus">Anti-Tetanus</label>
                            <select type="text" name="anti_tetanus" class="rounded-md p-3 ps-2 border-0" disabled>
                                <option value="">Select here</option>
                                <option value="1,5000 u" @if ($treatment->exposure->anti_titanus === '1,5000 u') selected @endif>1,500 u
                                </option>
                                <option value="5,000 u" @if ($treatment->exposure->anti_titanus === '5,000 u') selected @endif>5,000 u
                                </option>
                                <option value="6,000 u" @if ($treatment->exposure->anti_titanus === '6,000 u') selected @endif>6,000 u
                                </option>
                                <option value="TOXOID" @if ($treatment->exposure->anti_titanus === 'TOXOID') selected @endif>TOXOID
                                </option>
                            </select>
                        </div>
                    </div>
            ...
            {{-- history of vaccine --}}
            @php
                $postDayVaccine = [0, 3, 7, 14, 28];
                $preDayVaccine = [0, 7, 21];
            @endphp
            <div class="grid grid-cols-1 bg-slate-100  p-1 md:grid-cols-2 lg:grid-cols-2 gap-2 mb-4">
                <div class="col-span-2 text-center uppercase font-bold text-white bg-red-500 p-2">
                ...
                <div class="col-span-2 md:grid grid-cols-1 md:grid-cols-5 lg:grid-cols-5">
                            ...
                            @foreach ($postDayVaccine as $r)
                                ...
                                @foreach ($treatment->post_exposure as $p)
                                    @if (intval($p->day) === $r)
                                        ...
                                        @endphp
                                        <div
                                            class="col-span-3 md:grid grid-cols-2 md:grid-cols-5 lg:grid-cols-5 gap-2 mb-4 border-t-4 border-red-500">
                                            <div class="flex flex-col">
                                                <label>Day</label>
                                                <input type="text" value="{{ $p->day }}"
                                                    class="rounded-md p-3 ps-2 border-0" readonly />
                                            </div>
                                            <div class="flex flex-col">
                                                <label>Date</label>
                                            ...
                                            <div class="flex flex-col col-span-2">
                                                ...
                                                <input type="text" value="Completed"
                                                    class="rounded-md p-3 ps-2 border-0 text-green-500" readonly />
                                ...
                                @if (!$postFound)
                                    <div
                                        ...
                                        <div class="flex flex-col col-span-2">
                                            <label>Status</label>
                                            <input type="text" value="In-completed"
                                                class="rounded-md p-3 ps-2 border-0 text-red-500" readonly />
                    ...
                    <div class="col-span-5">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-2 mb-4">
                            <div class="flex flex-col col-span-3 text-xl text-red-500">
                                <label class="font-bold">Booster Dose</label>
                                <div class="flex flex-col col-span-2">
                                    <input type="text" value="In-completed"
                                        class="rounded-md p-3 ps-2 border-0 text-red-500" readonly />
