<x-guest-layout>
    ...
    <div class="w-full max-w-sm p-4 bg-bgprimary border-bgprimary rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
        ...
        <form class="space-y-6" method="POST" action="{{ route('password.email') }}">
            @csrf
            <h5 class="text-xl font-medium text-white dark:text-white">Forgot Password</h5>
            <div>
            ...
            <button type="submit" class="w-full text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Email Password Reset Link</button>
